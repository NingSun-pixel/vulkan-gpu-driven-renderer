...
//从引用数组和顶点数组里还原出mesh
GPULineBuffers VulkanEngine::uploadLine(std::span<glm::vec4> vertices)
{
    ...
    AllocatedBuffer staging = create_buffer(vertexBufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY);
